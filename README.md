...
README.ai is a GitHub Copilot CLI agent that helps every team member create a polished "How to Work With Me" profile through a fun, guided conversation. No writing skills required — just answer a few questions and the AI does the rest.
...
Open GitHub Copilot CLI and invoke the README.ai agent:
```
@readme-ai
```
...
A: Absolutely! Just run `@readme-ai` again and the agent will detect your existing profile and let you edit it.
